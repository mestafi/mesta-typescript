 ...
 *     }
 */
export interface CreateV3BeneficiariesRequest {
    /** Type of beneficiary */
    type: CreateV3BeneficiariesRequest.Type;
    ...
    businessType?: CreateV3BeneficiariesRequest.BusinessType;
    /** Beneficiary email */
    email?: string;
    ...
    merchantId?: string;
    /** Beneficiary address */
    address: CreateV3BeneficiariesRequest.Address;
    /** Identity document details */
    identity?: CreateV3BeneficiariesRequest.Identity;
    /** At least one payment method must be provided */
    paymentMethods: CreateV3BeneficiariesRequest.PaymentMethods.Item[];
    /** Custom metadata */
...
export namespace CreateV3BeneficiariesRequest {
    /** Type of beneficiary */
    export const Type = {
