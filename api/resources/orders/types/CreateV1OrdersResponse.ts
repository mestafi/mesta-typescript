...
export interface CreateV1OrdersResponse {
    data?: CreateV1OrdersResponse.Data | undefined;
    /** Unique identifier for the API request */
    requestId?: number | undefined;
}

export namespace CreateV1OrdersResponse {
    export interface Data {
        ...
        /** Timestamp when the awaiting funds status expires (30 minutes from creation) */
