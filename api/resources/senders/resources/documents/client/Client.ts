...
export class DocumentsClient {
     ...
     *
     * @param {Mesta.senders.GetPresignedUrlDocumentsRequest} request
     * @param {DocumentsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Mesta.UnauthorizedError}
     * @throws {@link Mesta.ForbiddenError}
     ...
     *
     * @example
     *     await client.senders.documents.getPresignedUrl({
     *         id: "id",
     *         documentId: "documentId"
     *     })
     */
    public getPresignedUrl(
        request: Mesta.senders.GetPresignedUrlDocumentsRequest,
        requestOptions?: DocumentsClient.RequestOptions,
    ): core.HttpResponsePromise<Mesta.senders.GetPresignedUrlDocumentsResponse> {
    ...
    private async __getPresignedUrl(
        request: Mesta.senders.GetPresignedUrlDocumentsRequest,
        requestOptions?: DocumentsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Mesta.senders.GetPresignedUrlDocumentsResponse>> {
        const { id, documentId, type: type_ } = request;
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MestaEnvironment.Production,
                `v1/senders/${core.url.encodePathParam(id)}/documents/${core.url.encodePathParam(documentId)}/presigned-url`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Mesta.senders.GetPresignedUrlDocumentsResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/v1/senders/{id}/documents/{documentId}/presigned-url",
        );
    }
}
